...
select geocodigo,
count(case when dificuldade_enxergar = '1' OR dificuldade_enxergar = '2' 
--OR dificuldade_enxergar = '3' 
then 1 else null end) as dificuldade_enxergar,
count(case when dificuldade_ouvir = '1' OR dificuldade_ouvir = '2' 
--OR dificuldade_ouvir = '3' 
then 1 else null end) as dificuldade_ouvir,
count(case when dificuldade_caminhar = '1' OR dificuldade_caminhar = '2' 
--OR dificuldade_caminhar = '3' 
then 1 else null end) as dificuldade_caminhar,
count(case when deficiencia_intelectual = '1' then 1 else null end) as deficiencia_intelectual,
count(case when dificuldade_enxergar = '1' OR dificuldade_enxergar = '2' OR
		-- dificuldade_enxergar = '3' OR
                dificuldade_ouvir = '1' OR dificuldade_ouvir = '2' OR
                --dificuldade_ouvir = '3' OR
                dificuldade_caminhar = '1' OR dificuldade_caminhar = '2' OR
                --dificuldade_caminhar = '3'  OR
